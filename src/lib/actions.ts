...
export async function generateSectionExercisesAction(sectionData: {
  ...
  return apiPost(`/v1/sections/${sectionData.sectionId}/generate-exercises`, {
    ...
    datasetCreationCodingLanguage: sectionData.datasetCreationCodingLanguage,
    solutionCodingLanguage: sectionData.solutionCodingLanguage,
    futureTopics: sectionData.futureTopics,
  });
}
...
export async function getAdaptiveQuizResponsesAction(sessionId: string) {
  return apiPost(`/v1/adaptive-quiz/responses`, { sessionId });
}
