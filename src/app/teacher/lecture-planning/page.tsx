...
import { LecturePlanningForm } from "@/components/teacher/lecture-planning-form"
      ...
      <div className="relative mx-auto max-w-6xl p-4 md:p-6">
        <header className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm md:p-8">
          ...
          <p className="mt-1 text-sm text-slate-600">
            Build lecture outlines, capture how the class is progressing, and highlight what needs
            extra attention.
          </p>
        </header>
